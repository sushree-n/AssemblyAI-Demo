// Customer's original Java snippet from the take-home PDF.
// Reproduced verbatim (with clean formatting) so FIXED_CODE.java can be a real
// diff against the actual code the customer sent, not a paraphrase.
